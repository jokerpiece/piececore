...
@interface KinenbiViewController ()

@end

@implementation KinenbiViewController

- (void)loadView {
    [[NSBundle mainBundle] loadNibNamed:@"KinenbiViewController" owner:self options:nil];
}

- (void)viewDidLoadLogic {
    self.dataList = self.setting.kinenbiList;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //日にち
    UILabel *dayLabel = [[UILabel alloc] initWithFrame:CGRectMake(240,25,250,25)];
    dayLabel.text = kinenbi.date;
    dayLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:18];
